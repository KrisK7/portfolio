...
### **DISCOVER** <br> Understanding the Landscape

*Diverging to explore the full context*

**What happens here:**
This phase is about **listening, learning, and questioning assumptions.** Before any design begins, I need to understand your business, your users, and the ecosystem you operate in.

**Activities may include:**
- Stakeholder interviews (understanding your goals, constraints, and vision)
- User research (surveys, interviews, or analysis of existing data)
- Competitor analysis (what's working, what's not, where opportunities live)
- Audit of existing products or materials (if applicable)
...
### **DEFINE** <br> Framing the Challenge

*Converging to focus on what matters most*
...
### **DEVELOP** <br> Exploring Possibilities
...
- Design concept exploration (multiple visual directions)
- Early-stage usability testing (with real users or lightweight validation)

**Tools I use:**
Figma for design, FigJam for flows, prototyping tools for testing, and my curated research network for deeper validation when needed.

**You'll receive:**
- User flows and wireframes
- Clickable prototypes to test
- Multiple design directions to evaluate
- Early feedback from real users

**My promise:** We explore broadly before committing. The best solutions often come from unexpected places.

---

### **DELIVER** <br> Bringing It to Life
...
**Tools I use:**
Figma for production design, developer handoff tools, and collaboration platforms for seamless coordination with your team or my network.

**You'll receive:**
- Complete, pixel-perfect designs
- Design system or component library
- Developer-ready assets and documentation
- 30-day post-launch support

**My promise:** What we design together ships successfully and performs as intended.

## **Balanced Partnership**

Many clients continue our partnership beyond a single project. Whether through **retainer arrangements, fractional design leadership, or follow-on projects**, I'm here to support your evolving needs.
...
{{< accordion mode="open" >}}
  {{< accordionItem title="How long does each phase take?" open=true >}}
It depends on project scope. A focused website redesign might take 6–8 weeks total. A complex platform could span several months. We'll agree on timelines during the Define phase. 
...
Feedback is built into the process. Each phase includes structured review points, and I'm always available for ad-hoc conversations when clarity is needed.
  {{< /accordionItem >}}

  {{< accordionItem title="Can you work with my existing developers?"  >}}
Absolutely. I've partnered with countless internal development teams. My deliverables are built for smooth handoff
  {{< /accordionItem >}}
{{< /accordion >}}
